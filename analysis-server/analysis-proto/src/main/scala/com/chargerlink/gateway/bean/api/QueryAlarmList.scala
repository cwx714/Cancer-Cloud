...
/** * 查询终端设备报警消息列表的请求消息定义。
  ...
  * @param alarmCode
  *  / (可选)查询的报警代码。null：返回所有代码的报警消息。
  */
@SerialVersionUID(0L)
final case class QueryAlarmList(
    deviceType: com.chargerlink.gateway.bean.common.DeviceType,
    deviceId: String,
    subDevice: scala.Option[String] = None,
    startTime: Long,
    stopTime: Long,
    alarmCode: scala.Option[Int] = None
    ) extends com.trueaccord.scalapb.GeneratedMessage with com.trueaccord.scalapb.Message[QueryAlarmList] with com.trueaccord.lenses.Updatable[QueryAlarmList] {
    @transient
    ...
    private[this] def __computeSerializedValue(): Int = {
      ...
      if (alarmCode.isDefined) { __size += _root_.com.google.protobuf.CodedOutputStream.computeUInt32Size(6, alarmCode.get) }
      __size
    }
    ...
    def writeTo(`_output__`: _root_.com.google.protobuf.CodedOutputStream): Unit = {
      ...
      alarmCode.foreach { __v =>
        _output__.writeUInt32(6, __v)
      };
    }
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.chargerlink.gateway.bean.api.QueryAlarmList = {
      ...
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 48 =>
            __alarmCode = Some(_input__.readUInt32())
          case tag => _input__.skipField(tag)
        }
      }
      if (__requiredFields0 != 0L) { throw new _root_.com.google.protobuf.InvalidProtocolBufferException("Message missing required fields.") } 
      com.chargerlink.gateway.bean.api.QueryAlarmList(
    ...
    def withDeviceType(__v: com.chargerlink.gateway.bean.common.DeviceType): QueryAlarmList = copy(deviceType = __v)
    def withDeviceId(__v: String): QueryAlarmList = copy(deviceId = __v)
    def getSubDevice: String = subDevice.getOrElse("")
    def clearSubDevice: QueryAlarmList = copy(subDevice = None)
    def withSubDevice(__v: String): QueryAlarmList = copy(subDevice = Some(__v))
    def withStartTime(__v: Long): QueryAlarmList = copy(startTime = __v)
    def withStopTime(__v: Long): QueryAlarmList = copy(stopTime = __v)
    def getAlarmCode: Int = alarmCode.getOrElse(0)
    def clearAlarmCode: QueryAlarmList = copy(alarmCode = None)
    def withAlarmCode(__v: Int): QueryAlarmList = copy(alarmCode = Some(__v))
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 6 => alarmCode.map(_root_.scalapb.descriptors.PInt).getOrElse(_root_.scalapb.descriptors.PEmpty)
      }
    }
    override def toString: String = _root_.com.trueaccord.scalapb.TextFormat.printToSingleLineUnicodeString(this)
    def companion = com.chargerlink.gateway.bean.api.QueryAlarmList
}

object QueryAlarmList extends com.trueaccord.scalapb.GeneratedMessageCompanion[com.chargerlink.gateway.bean.api.QueryAlarmList] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[com.chargerlink.gateway.bean.api.QueryAlarmList] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.chargerlink.gateway.bean.api.QueryAlarmList = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.chargerlink.gateway.bean.api.QueryAlarmList] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ApiBaseProto.javaDescriptor.getMessageTypes.get(3)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ApiBaseProto.scalaDescriptor.messages(3)
  ...
  lazy val defaultInstance = com.chargerlink.gateway.bean.api.QueryAlarmList(
    deviceType = com.chargerlink.gateway.bean.common.DeviceType.DEVICE_VEHICLE_GB_V1,
    deviceId = "",
    startTime = 0L,
    stopTime = 0L
  )
  implicit class QueryAlarmListLens[UpperPB](_l: _root_.com.trueaccord.lenses.Lens[UpperPB, com.chargerlink.gateway.bean.api.QueryAlarmList]) extends _root_.com.trueaccord.lenses.ObjectLens[UpperPB, com.chargerlink.gateway.bean.api.QueryAlarmList](_l) {
    ...
    def alarmCode: _root_.com.trueaccord.lenses.Lens[UpperPB, Int] = field(_.getAlarmCode)((c_, f_) => c_.copy(alarmCode = Some(f_)))
    def optionalAlarmCode: _root_.com.trueaccord.lenses.Lens[UpperPB, scala.Option[Int]] = field(_.alarmCode)((c_, f_) => c_.copy(alarmCode = f_))
  }
  ...
  final val ALARM_CODE_FIELD_NUMBER = 6
}
